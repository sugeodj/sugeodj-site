    ...
    >
      ...
      <div className={clsx('flex items-center gap-4')}>
        <div className={clsx('flex flex-col items-center gap-2')}>
          ...
          />
          <ReactionCounter count={meta?.reactionsDetail?.CLAPPING} />
        </div>
        <div className={clsx('flex flex-col items-center gap-2')}>
          <EmojiReaction
          ...
          />
          <ReactionCounter count={meta?.reactionsDetail?.AMAZED} />
        </div>
        <div className={clsx('flex flex-col items-center gap-2')}>
          <EmojiReaction
          ...
          />
          <ReactionCounter count={meta?.reactionsDetail?.THINKING} />
        </div>
      </div>
      <div className={clsx('flex items-start gap-2')}>
        <div className={clsx('flex flex-col items-center gap-2')}>
          <InsightButton views={meta?.views} shares={meta?.shares} reactions={meta?.reactions} />
        </div>
        <div className={clsx('flex flex-col items-center gap-2')}>
          <ShareButton
            onItemClick={(type) => {
          ...
          />
          <ReactionCounter count={meta?.shares} />
        </div>
      </div>
    </m.div>
  );
